...
// FlashAttention (prefill / varlen-style): q is packed [total_q, num_heads, head_dim].
// External signature intentionally matches paged_attention_prefill_ to minimize framework changes.
class FlashAttentionPrefill {
public:
    /**
     * @brief FlashAttentionPrefill operator signature
     * * Argument order:
